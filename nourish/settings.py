...
SECRET_KEY = 'django-insecure-ixrp#!p_z!kczfiyyt+py)&)la+o5s&nmo4w6%y*edvn%-o_*y'
...
AUTHENTICATION_BACKENDS = (
    # Default backend (allows login with username)
    'django.contrib.auth.backends.ModelBackend',

    # Allauth backend (allows login with email/social accounts)
